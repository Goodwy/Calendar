...
import com.goodwy.calendar.databinding.ActivitySettingsBinding
...
//        setupEdgeToEdge(padBottomSystem = listOf(settingsNestedScrollview))
    ...
    private fun setupSettingItems() {
        ...
        binding.apply {
            arrayOf(
                ...
                settingsCaldavLabel,
                settingsNewEventsLabel,
                settingsWeeklyViewLabel,
                settingsMonthlyViewLabel,
                settingsEventListsLabel,
                settingsWidgetsLabel,
                settingsEventsLabel,
                settingsTasksLabel,
                settingsBackupsLabel,
                settingsMigratingLabel,
                settingsOtherLabel
            ).forEach {
            ...
            arrayOf(
                ...
                settingsRemindersHolder,
                settingsCaldavHolder,
                settingsNewEventsHolder,
                settingsWeeklyViewHolder,
                settingsMonthlyViewHolder,
                settingsEventListsHolder,
                settingsWidgetsHolder,
                settingsEventsHolder,
                settingsTasksHolder,
            ...
            arrayOf(
                ...
                settingsManageEventTypesChevron,
                settingsManageQuickFilterEventChevron,
                settingsCustomizeNotificationsChevron,
                settingsManageSyncedChevron,
                settingsWidgetColorCustomizationChevron,
                settingsDeleteAllEventsChevron,
                settingsManageAutomaticBackupsChevron,
                eventsExportChevron,
                eventsImportChevron,
                settingsExportChevron,
                settingsImportChevron,
    ...
    private fun setupStartWeekOn() = binding.apply {
        val items = arrayListOf(
            RadioItem(DateTimeConstants.SUNDAY, getString(com.goodwy.commons.R.string.sunday)),
            RadioItem(DateTimeConstants.MONDAY, getString(com.goodwy.commons.R.string.monday)),
            RadioItem(DateTimeConstants.TUESDAY, getString(com.goodwy.commons.R.string.tuesday)),
            RadioItem(DateTimeConstants.WEDNESDAY, getString(com.goodwy.commons.R.string.wednesday)),
            RadioItem(DateTimeConstants.THURSDAY, getString(com.goodwy.commons.R.string.thursday)),
            RadioItem(DateTimeConstants.FRIDAY, getString(com.goodwy.commons.R.string.friday)),
            RadioItem(DateTimeConstants.SATURDAY, getString(com.goodwy.commons.R.string.saturday)),
        )
    ...
    private fun setupDeleteAllEvents() = binding.apply {
        ensureBackgroundThread {
            val eventSize = eventsDB.getEventIds().size
    ...
    private fun getDisplayPastEventsText(displayPastEvents: Int): String {
        return if (displayPastEvents == 0) {
            getString(com.goodwy.commons.R.string.never)
        } else {
...
//            }
    ...
    private fun updateDefaultDurationText() {
        ...
        binding.settingsDefaultDuration.text = if (duration == 0) {
            "0 ${getString(com.goodwy.commons.R.string.minutes_raw)}"
        } else {
        ...
        ensureBackgroundThread {
            ...
            if (events.isEmpty()) {
                ...
                IcsExporter(this).exportEvents(outputStream, events, true) { result ->
                    toast(
                        when (result) {
                            IcsExporter.ExportResult.EXPORT_OK -> com.goodwy.commons.R.string.exporting_successful
                            IcsExporter.ExportResult.EXPORT_PARTIAL -> com.goodwy.commons.R.string.exporting_some_entries_failed
