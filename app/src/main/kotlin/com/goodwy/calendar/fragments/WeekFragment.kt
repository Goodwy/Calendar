...
import com.goodwy.calendar.databinding.*
import com.goodwy.calendar.dialogs.EditRepeatingEventDialog
import com.goodwy.calendar.extensions.*
import com.goodwy.calendar.helpers.*
import com.goodwy.calendar.interfaces.WeekFragmentListener
import com.goodwy.calendar.interfaces.WeeklyCalendar
import com.goodwy.calendar.models.Event
import com.goodwy.calendar.models.EventWeeklyView
...
class WeekFragment : Fragment(), WeeklyCalendar {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        scrollView.onGlobalLayout {
            if (fullHeight < scrollView.height) {
                scrollView.layoutParams.height = fullHeight - res.getDimension(com.goodwy.commons.R.dimen.one_dp).toInt()
            }
    ...
    private fun setupDayLabels() {
        ...
        for (i in 0 until config.weeklyViewDays) {
            ...
            val labelIDs = if (useLongerDayLabels) {
                com.goodwy.commons.R.array.week_days_short
            } else {
                com.goodwy.commons.R.array.week_day_letters
            }
    ...
    private fun updateViewScale() {
        ...
        val oneDp = res.getDimension(com.goodwy.commons.R.dimen.one_dp).toInt()
    ...
    private fun addCurrentTimeIndicator() {
        if (todayColumnIndex != -1) {
            ...
            currentTimeView = WeekNowMarkerBinding.inflate(layoutInflater).root.apply {
                ...
                val extraWidth = res.getDimension(com.goodwy.commons.R.dimen.activity_margin).toInt()
